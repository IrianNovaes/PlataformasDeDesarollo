...
namespace WebApplication1.Controllers
{
    ...
    partial class AutoGeneratedIRemoteService : IRemoteService
    {
        ...
        /// <inheritdoc />
        Task<Usuario> IRemoteService.UpdateUsuario(int id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("UpdateUsuario", new Type[] { typeof(int) });
            return (Task<Usuario>)func(Client, arguments);
        }
        ...
        /// <inheritdoc />
        Task<TipoTarea> IRemoteService.UpdateTipoTarea(int id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("UpdateTipoTarea", new Type[] { typeof(int) });
            return (Task<TipoTarea>)func(Client, arguments);
        }
        ...
        /// <inheritdoc />
        Task<Tarea> IRemoteService.UpdateTarea(int id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("UpdateTarea", new Type[] { typeof(int) });
            return (Task<Tarea>)func(Client, arguments);
        }
        ...
        /// <inheritdoc />
        Task<Rol> IRemoteService.UpdateRol(int id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("UpdateRol", new Type[] { typeof(int) });
            return (Task<Rol>)func(Client, arguments);
        }
        ...
        /// <inheritdoc />
        Task<Detalle> IRemoteService.UpdateDetalle(int id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("UpdateDetalle", new Type[] { typeof(int) });
            return (Task<Detalle>)func(Client, arguments);
        }
        ...
        /// <inheritdoc />
        Task<Recurso> IRemoteService.UpdateRecurso(int id)
        {
            var arguments = new object[] { id };
            var func = requestBuilder.BuildRestResultFuncForMethod("UpdateRecurso", new Type[] { typeof(int) });
            return (Task<Recurso>)func(Client, arguments);
        }
